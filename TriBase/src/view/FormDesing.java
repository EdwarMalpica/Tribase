...
public class FormDesing {
	...
	public FormDesing(String string1, String string2, String string3, String string4, String string5, String string6,
	...
	public void buildDesing() {
		finalString1 = addSpace(string1, ConstantsSpaceString.FORM_String_1);
		finalString2 = addSpace(string2, ConstantsSpaceString.FORM_String_2);
		finalString3 = addSpace(string3, ConstantsSpaceString.FORM_String_3);
		finalString4 = addSpace(string4, ConstantsSpaceString.FORM_String_4);
		finalString5 = addSpace(string5, ConstantsSpaceString.FORM_String_5);
		finalString6 = addSpace(string6, ConstantsSpaceString.FORM_String_6);
		finalString7 = addSpace(string7, ConstantsSpaceString.FORM_String_7);
		finalString8 = addSpace(string8, ConstantsSpaceString.FORM_String_8);
		finalString9 = addSpace(string9, ConstantsSpaceString.FORM_String_9);
