...
public class ErrorDesing {
	...
	private String finalString10;
	
	

	public ErrorDesing(String string1, String string2, String string3, String string4, String string5, String string6,
	...
	public void buildDesing() {
		finalString1 = addSpace(string1, ConstantsSpaceString.ERROR_String_1);
		finalString2 = addSpace(string2, ConstantsSpaceString.ERROR_String_2);
		finalString3 = addSpace(string3, ConstantsSpaceString.ERROR_String_3);
		finalString4 = addSpace(string4, ConstantsSpaceString.ERROR_String_4);
		finalString5 = addSpace(string5, ConstantsSpaceString.ERROR_String_5);
		finalString6 = addSpace(string6, ConstantsSpaceString.ERROR_String_6);
		finalString7 = addSpace(string7, ConstantsSpaceString.ERROR_String_7);
		finalString8 = addSpace(string8, ConstantsSpaceString.ERROR_String_8);
		finalString9 = addSpace(string9, ConstantsSpaceString.ERROR_String_9);
		finalString10 = addSpace(string10, ConstantsSpaceString.ERROR_String_10);
	...
	public String getFinalString10() {
		return finalString10;
	}


	public void setFinalString10(String finalString10) {
		this.finalString10 = finalString10;
	}
